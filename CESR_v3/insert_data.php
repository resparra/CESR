...
$result = mysqli_query($con, "SELECT * from Worktime WHERE date = '$date' AND  p_id = '$_POST[project]' AND ph_id = '$_POST[phase]' AND t_id = '$_POST[task]'");
...
if(mysqli_num_rows($result)){
  ...
  echo $newTime;
  echo "<br/>";
  mysqli_query($con, "UPDATE Worktime SET hours = $newTime WHERE p_id = '$_POST[project]' AND ph_id = '$_POST[phase]' AND t_id = '$_POST[task]' AND w_id = $_SESSION[id]");
}
else{
//else, add new entry

$sql="INSERT INTO Worktime (w_id, date, p_id, ph_id, t_id, comment, hours, audience, modality)
VALUES
